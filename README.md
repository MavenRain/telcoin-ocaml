...
| `tn_consensus` | DAG, Bullshark commit rule, proposer/voter/node machines | ⏳ planned |
...
Current suite: **45 checks green** — 24 BCS golden-vector conformance checks,
12 foundation cases (crypto, scalars, committee threshold table), 9
vertex/certificate cases (the full assembly rejection matrix).
